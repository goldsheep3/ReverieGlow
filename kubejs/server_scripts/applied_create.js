...
ServerEvents.recipes(event => {
    // 电路板压印
	event.custom(ifiniDeploying('ae2:printed_logic_processor', 'minecraft:gold_ingot', 'ae2:logic_processor_press'))
	event.custom(ifiniDeploying('ae2:printed_calculation_processor', 'ae2:certus_quartz_crystal', 'ae2:calculation_processor_press'))
	event.custom(ifiniDeploying('ae2:printed_engineering_processor', 'minecraft:diamond', 'ae2:engineering_processor_press'))
    ...
    // 线缆清洗
	event.recipes.createSplashing(['ae2:fluix_smart_cable'], ['#ae2:smart_cable'])
	event.recipes.createSplashing(['ae2:fluix_covered_cable'], ['#ae2:covered_cable'])
	event.recipes.createSplashing(['ae2:fluix_glass_cable'], ['#ae2:glass_cable'])
	event.recipes.createSplashing(['ae2:fluix_covered_dense_cable'], ['#ae2:covered_dense_cable'])
	event.recipes.createSplashing(['ae2:fluix_smart_dense_cable'], ['#ae2:smart_dense_cable'])
  })