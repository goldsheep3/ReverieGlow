...
ServerEvents.recipes(event => {
    ...
    const mythicbotany_biomes = ["mythicbotany:alfheim_hills", "mythicbotany:alfheim_lakes", "mythicbotany:alfheim_plains", "mythicbotany:dreamwood_forest", "mythicbotany:golden_fields"]
    // ore_excavation()
    // 单数产出类矿石
    let ores = [
        // mek10
        ...
        // botania
        ["源质钢", "mythicbotany:raw_elementium", "raw_elementium", 256, 64, mythicbotany_biomes, 1200, 512, 326464645, 3, 1],
        ["龙石", "botania:dragonstone", "dragonstone", 192, 5, mythicbotany_biomes, 2400, 2048, 984265853, 3, 1],
        // thermal
