const UPDATE_HISTORY = [
  ...
  { version: "b2.2", desc: "[模组/事件]阻止热力的lead和tin生成矿石；矿石开掘生成全面重写，覆写原模组逻辑，新增钻石/绿宝石/红石原石块（尚无处理）；新增mek配方lib；修正了时间核心的文字描述" },
  { version: "b2.3", desc: "[模组]更新了通用拼音搜索等模组，修复AE2无法拼音搜索的问题" },
  // { version: "b2.4", desc: "[]" },
  // { version: "b2.5", desc: "[]" },
  // { version: "b2.6", desc: "[]" },
  // { version: "b2.7", desc: "[]" },
